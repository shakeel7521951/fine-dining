  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center min-h-screen bg-white px-4 py-12">
      ...
      <div className="w-full md:w-2/4 text-center px-6">
        <p className="uppercase text-gray-400 tracking-widest mb-2">— Welcome —</p>
        ...
        <p className="text-gray-700 leading-relaxed mb-8">
          ...
          quis nostrud exercitation ullamco. Quia consequuntur magni dolores eos
          qui ratione voluptatem sequi nesciunt. Animi, id est laborum et
